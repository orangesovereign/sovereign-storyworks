...
Locales['en'] = {
  ...
  access_no_character = 'No character selected.',
  access_wrong_job = 'This work is not for the likes of you.',
  access_grade_low = 'You lack the standing for this work.',
  access_grade_high = 'This is beneath your station.',
  locked_prereq = 'You must finish earlier chapters before this one opens.',
  already_done_once = 'You have already seen this through — it does not come again.',
  on_cooldown_daily = 'You have done this today. Come back after the daily reset.',
  on_cooldown_weekly = 'You have done this already this week. Try again next week.',
  on_cooldown_monthly = 'You have done this already this month. Try again next month.',
  ...
  talk_prompt = 'Talk',
  eliminate_progress = 'Targets down: %d of %d.',
  eliminate_done = 'The area is clear.',
  eliminate_blip_foe = 'Hostile',
  eliminate_blip_hunt = 'Quarry',
  escort_started = 'Keep them safe and close.',
  escort_arrived = 'Safely delivered.',
  escort_died = 'You let them die.',
  escort_separated = 'You strayed too far — they were left behind.',
  escort_blip = 'Escort',
  defend_started = 'Hold the ground — %d seconds.',
  defend_wave = 'Wave %d of %d incoming!',
  defend_remaining = 'Hold on — %d seconds left.',
  defend_done = 'You held the line.',
  defend_abandoned = 'You abandoned the position.',
  defend_blip_foe = 'Attacker',
  reward_received = 'You received: %s.',
  reward_currency_money = '$%s',
  reward_currency_gold = '%s gold',
  reward_currency_xp = '%s XP',
}
