-- Sovereign Storyworks — DataView buffer utility (client)
-- Phase 0 (Foundations & Spikes) | needed by spike S2 (native ped speech struct)
-- Source: gottfriedleibniz's public DataView-in-Lua gist, as documented in
-- femga/rdr3_discoveries audio/audio_banks/README.md. Credit: gottfriedleibniz.
